    ...
    return (
        <div className='flex flex-col pt-5 md:pt-20 items-center gap-8'>
            <div className='flex flex-col gap-3 items-center'>
                ...
                <h2 className='text-lg text-gray-500 text-center w-2/3 md:w-full'>Search Your Doctor and Book Appointment in one click
                </h2>
                <div className='flex gap-2 justify-center mt-2'>
                    <Input placeholder='Search...' className="w-[200px] md:w-[300px] text-gray-500 focus-visible:outline-none" />
            ...
            <div className='grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-6'>
                {categories!=null?categories?.slice(0, 6)?.map((curr, index) =>
                (<CategoryCard key={index}
                    ...
                    return(
                        <Skeleton key={index} className='h-[100px] w-[160px] rounded-xl gap-4 '/>
                    )
                })}
